...
class CreateEc2Instance():
    ...
    def setup(self, use_elastic_ip, public_ip, instance_name):
    ...
    def stage01(self):
        ...
        self._conn.create_tags([self._instance.id], {"Name": self._instance_name})
        ...
        self._run_command('chmod +x *.sh')
        self._run_command('./common_server_install.sh')
