...
DATA = [
    ['Microsoft Windows 7', 7452],
    ['Android', 2513],
    ['Linux', 2363],
    ['Microsoft Windows XP', 1915],
    ['Microsoft Windows 8', 815],
    ['Darwin', 637],
    ['Microsoft Windows Vista', 586],
    ['Microsoft Windows Server 2008 "R2"', 464],
    ['Microsoft Windows 8.1', 453],
    ['Microsoft Windows Server 2003', 79],
    ['Microsoft Windows Server 2003 "R2"', 73],
    ['Microsoft Windows Server 2008', 35],
    ['Unknown', 19],
    ['Microsoft Windows 2000', 17],
    ['Microsoft Windows Server 2012', 16],
    ['Microsoft Windows Server "Longhorn"', 11],
    ['Microsoft', 10],
    ['FreeBSD', 10],
    ['Microsoft Windows 8 Server', 9],
    ['Microsoft Windows Server 2012 R2', 8],
