...
cdef class Fit2Wu:
    ...
    cdef _build_template_file(self):
        """
    ...
    cdef _copy_important_files(self):
        """
    ...
    cdef _create_areas(self, int pix_y):
        """
    ...
    cdef _create_job_xml(self, file_name, pixels_in_file):
        """
...
'''.format(pixels_in_file))
    ...
    cdef _create_observation_file(self, filename, data, pixels):
        """
    ...
    cdef _create_output_file(self, area, pixels):
        """
    ...
    cdef _enough_layers(self, pixels):
        """
    ...
    cdef _fanout_path(self, file_name):
        """
    ...
    cdef _get_filters_sort_layers(self):
        """
    ...
    cdef _get_pixels(self, int pix_x, int pix_y):
        """
    ...
    cdef _get_rounded_redshift(self):
        """
    ...
    cdef _store_tags(self, register_id):
        """
