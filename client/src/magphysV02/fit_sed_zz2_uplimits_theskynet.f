...
czz added parameters
      real*8 z_zmet(nmod),z_lzmet(nmod)
      real*8 z_tform(nmod),z_gamma(nmod),z_tlastb(nmod),z_agem(nmod),z_ager(nmod)
      real*8 z_ltform(nmod),z_lgamma(nmod),z_ltlastb(nmod),z_lagem(nmod),z_lager(nmod)
      real*8 z_sfr16(nmod),z_sfr17(nmod),z_sfr18(nmod),z_sfr19(nmod),z_sfr29(nmod)
      real*8 z_lsfr16(nmod),z_lsfr17(nmod),z_lsfr18(nmod),z_lsfr19(nmod),z_lsfr29(nmod)
      real*8 z_fb16(nmod),z_fb17(nmod),z_fb18(nmod),z_fb19(nmod),z_fb29(nmod)
      real*8 z_lfb16(nmod),z_lfb17(nmod),z_lfb18(nmod),z_lfb19(nmod),z_lfb29(nmod)
czz added parameters end

c     chi2, scaling factors, etc.
      real*8 flux_mod(nmax)
      real*8 chi2,chi2_sav,chi2_new,df
      real*8 a,num,den,a_sav,chi2_nd
...
czz added parameters
      real*8 z_zmet_min,z_zmet_max,z_dzmet
      real*8 z_ltform_min,z_ltform_max,z_dltform
      real*8 z_lgamma_min,z_lgamma_max,z_dlgamma
      real*8 z_ltlastb_min,z_ltlastb_max,z_dltlastb
      real*8 z_lagem_min,z_lagem_max,z_dlagem
      real*8 z_lager_min,z_lager_max,z_dlager
      real*8 z_lsfr16_min,z_lsfr16_max,z_dlsfr16
      real*8 z_lsfr17_min,z_lsfr17_max,z_dlsfr17
      real*8 z_lsfr18_min,z_lsfr18_max,z_dlsfr18
      real*8 z_lsfr19_min,z_lsfr19_max,z_dlsfr19
      real*8 z_lsfr29_min,z_lsfr29_max,z_dlsfr29
      real*8 z_lfb16_min,z_lfb16_max,z_dlfb16
      real*8 z_lfb17_min,z_lfb17_max,z_dlfb17
...
czz added parameters
      real*8 z_pct_zmet(5)
      real*8 z_pct_ltform(5)
      real*8 z_pct_lgamma(5)
      real*8 z_pct_ltlastb(5)
      real*8 z_pct_lagem(5)
      real*8 z_pct_lager(5)
      real*8 z_pct_lsfr16(5)
      real*8 z_pct_lsfr17(5)
      real*8 z_pct_lsfr18(5)
      real*8 z_pct_lsfr19(5)
      real*8 z_pct_lsfr29(5)
      real*8 z_pct_lfb16(5)
      real*8 z_pct_lfb17(5)
...
czz added parameters
      real*8 z_pzmet2(nbinmax2)
      real*8 z_pltform2(nbinmax2)
      real*8 z_plgamma2(nbinmax2)
      real*8 z_pltlastb2(nbinmax2)
      real*8 z_plagem2(nbinmax2)
      real*8 z_plager2(nbinmax2)
      real*8 z_plsfr162(nbinmax2)
      real*8 z_plsfr172(nbinmax2)
      real*8 z_plsfr182(nbinmax2)
      real*8 z_plsfr192(nbinmax2)
      real*8 z_plsfr292(nbinmax2)
      real*8 z_plfb162(nbinmax2)
      real*8 z_plfb172(nbinmax2)
...
czz added parameters
      real*8 z_zmet2_hist(nbinmax2)
      real*8 z_ltform2_hist(nbinmax2)
      real*8 z_lgamma2_hist(nbinmax2)
      real*8 z_ltlastb2_hist(nbinmax2)
      real*8 z_lagem2_hist(nbinmax2)
      real*8 z_lager2_hist(nbinmax2)
      real*8 z_lsfr162_hist(nbinmax2)
      real*8 z_lsfr172_hist(nbinmax2)
      real*8 z_lsfr182_hist(nbinmax2)
      real*8 z_lsfr192_hist(nbinmax2)
      real*8 z_lsfr292_hist(nbinmax2)
      real*8 z_lfb162_hist(nbinmax2)
      real*8 z_lfb172_hist(nbinmax2)
...
czz added parameters
      integer z_nbin_zmet,z_nbin2_zmet
      integer z_nbin_ltform,z_nbin2_ltform
      integer z_nbin_lgamma,z_nbin2_lgamma
      integer z_nbin_ltlastb,z_nbin2_ltlastb
      integer z_nbin_lagem,z_nbin2_lagem
      integer z_nbin_lager,z_nbin2_lager
      integer z_nbin_lsfr16,z_nbin2_lsfr16
      integer z_nbin_lsfr17,z_nbin2_lsfr17
      integer z_nbin_lsfr18,z_nbin2_lsfr18
      integer z_nbin_lsfr19,z_nbin2_lsfr19
      integer z_nbin_lsfr29,z_nbin2_lsfr29
      integer z_nbin_lfb16,z_nbin2_lfb16
      integer z_nbin_lfb17,z_nbin2_lfb17
...
czz added parameters
      real*8 z_pzmet(nbinmax1)
      real*8 z_pltform(nbinmax1)
      real*8 z_plgamma(nbinmax1)
      real*8 z_pltlastb(nbinmax1)
      real*8 z_plagem(nbinmax1)
      real*8 z_plager(nbinmax1)
      real*8 z_plsfr16(nbinmax1)
      real*8 z_plsfr17(nbinmax1)
      real*8 z_plsfr18(nbinmax1)
      real*8 z_plsfr19(nbinmax1)
      real*8 z_plsfr29(nbinmax1)
      real*8 z_plfb16(nbinmax1)
      real*8 z_plfb17(nbinmax1)
...
czz added parameters
      real*8 z_zmet_hist(nbinmax1)
      real*8 z_ltform_hist(nbinmax1)
      real*8 z_lgamma_hist(nbinmax1)
      real*8 z_ltlastb_hist(nbinmax1)
      real*8 z_lagem_hist(nbinmax1)
      real*8 z_lager_hist(nbinmax1)
      real*8 z_lsfr16_hist(nbinmax1)
      real*8 z_lsfr17_hist(nbinmax1)
      real*8 z_lsfr18_hist(nbinmax1)
      real*8 z_lsfr19_hist(nbinmax1)
      real*8 z_lsfr29_hist(nbinmax1)
      real*8 z_lfb16_hist(nbinmax1)
      real*8 z_lfb17_hist(nbinmax1)
...
czz added parameters
      real*8 z_i_lzmet(nmod)
      real*8 z_i_zmet(nmod)
      real*8 z_i_ltform(nmod)
      real*8 z_i_lgamma(nmod)
      real*8 z_i_ltlastb(nmod)
      real*8 z_i_lagem(nmod)
      real*8 z_i_lager(nmod)
      real*8 z_i_lsfr16(nmod)
      real*8 z_i_lsfr17(nmod)
      real*8 z_i_lsfr18(nmod)
      real*8 z_i_lsfr19(nmod)
      real*8 z_i_lsfr29(nmod)
      real*8 z_i_lfb16(nmod)
      real*8 z_i_lfb17(nmod)
...
czz added parameters
                  z_zmet(i_sfh)=fprop_sfh(i_sfh,3)              ! metalicity
                  z_lzmet(i_sfh)=dlog10(z_zmet(i_sfh))          ! log(metalicity)

                  z_tform(i_sfh)=fprop_sfh(i_sfh,1)             ! age of the oldest stars (yr)
                  z_gamma(i_sfh)=fprop_sfh(i_sfh,2)             ! star formation timescale (Gyr^-1)
                  z_tlastb(i_sfh)=fprop_sfh(i_sfh,13)           ! time since the last burst of SF
                  z_agem(i_sfh)=fprop_sfh(i_sfh,19)             ! mass-weighted age
                  z_ager(i_sfh)=fprop_sfh(i_sfh,20)             ! r-band light-weighted age
                  z_sfr16(i_sfh)=fprop_sfh(i_sfh,8)             ! SFR(1e6)
                  z_sfr17(i_sfh)=fprop_sfh(i_sfh,9)             ! SFR(1e7)
                  z_sfr18(i_sfh)=fprop_sfh(i_sfh,10)            ! SFR(1e8)
                  z_sfr19(i_sfh)=fprop_sfh(i_sfh,11)            ! SFR(1e9)
                  z_sfr29(i_sfh)=fprop_sfh(i_sfh,12)            ! SFR(2e9)
                  z_fb16(i_sfh)=fprop_sfh(i_sfh,14)             ! fraction of stellar mass formed over the last 1e6 yr
                  z_fb17(i_sfh)=fprop_sfh(i_sfh,15)             ! fraction of stellar mass formed over the last 1e7 yr
                  z_fb18(i_sfh)=fprop_sfh(i_sfh,16)             ! fraction of stellar mass formed over the last 1e8 yr
                  z_fb19(i_sfh)=fprop_sfh(i_sfh,17)             ! fraction of stellar mass formed over the last 1e9 yr
                  z_fb29(i_sfh)=fprop_sfh(i_sfh,18)             ! fraction of stellar mass formed over the last 2e9 yr

                  z_ltform(i_sfh)=dlog10(z_tform(i_sfh))
                  z_lgamma(i_sfh)=z_gamma(i_sfh)
                  z_ltlastb(i_sfh)=dlog10(z_tlastb(i_sfh))
                  z_lagem(i_sfh)=dlog10(z_agem(i_sfh))
                  z_lager(i_sfh)=dlog10(z_ager(i_sfh))
                  z_lsfr16(i_sfh)=dlog10(z_sfr16(i_sfh))
                  z_lsfr17(i_sfh)=dlog10(z_sfr17(i_sfh))
                  z_lsfr18(i_sfh)=dlog10(z_sfr18(i_sfh))
                  z_lsfr19(i_sfh)=dlog10(z_sfr19(i_sfh))
                  z_lsfr29(i_sfh)=dlog10(z_sfr29(i_sfh))
                  z_lfb16(i_sfh)=z_fb16(i_sfh)
                  z_lfb17(i_sfh)=z_fb17(i_sfh)
...
c     Observed fluxes: Jy -> Lsun/Hz
     ...
     +              *3.283608731e-33*(dist(i_gal)**2)
            ...
            if (flux_obs(i_gal,k).le.0.and.sigma(i_gal,k).gt.0.) then
               sigma(i_gal,k)=sigma(i_gal,k)*1.e-23
     +              *3.283608731e-33*(dist(i_gal)**2)
            endif
...
czz added parameters
c     metalicity
         call get_histgrid(z_dzmet,z_zmet_min,z_zmet_max,z_nbin_zmet,z_zmet_hist)
         call get_histgrid(z_dltform,z_ltform_min,z_ltform_max,z_nbin_ltform,z_ltform_hist)
         call get_histgrid(z_dlgamma,z_lgamma_min,z_lgamma_max,z_nbin_lgamma,z_lgamma_hist)
         call get_histgrid(z_dltlastb,z_ltlastb_min,z_ltlastb_max,z_nbin_ltlastb,z_ltlastb_hist)
         call get_histgrid(z_dlagem,z_lagem_min,z_lagem_max,z_nbin_lagem,z_lagem_hist)
         call get_histgrid(z_dlager,z_lager_min,z_lager_max,z_nbin_lager,z_lager_hist)
         call get_histgrid(z_dlsfr16,z_lsfr16_min,z_lsfr16_max,z_nbin_lsfr16,z_lsfr16_hist)
         call get_histgrid(z_dlsfr17,z_lsfr17_min,z_lsfr17_max,z_nbin_lsfr17,z_lsfr17_hist)
         call get_histgrid(z_dlsfr18,z_lsfr18_min,z_lsfr18_max,z_nbin_lsfr18,z_lsfr18_hist)
         call get_histgrid(z_dlsfr19,z_lsfr19_min,z_lsfr19_max,z_nbin_lsfr19,z_lsfr19_hist)
         call get_histgrid(z_dlsfr29,z_lsfr29_min,z_lsfr29_max,z_nbin_lsfr29,z_lsfr29_hist)
         call get_histgrid(z_dlfb16,z_lfb16_min,z_lfb16_max,z_nbin_lfb16,z_lfb16_hist)
         call get_histgrid(z_dlfb17,z_lfb17_min,z_lfb17_max,z_nbin_lfb17,z_lfb17_hist)
...
czz added parameters
czzworking
            aux=((z_zmet(i_sfh)-z_zmet_min)/(z_zmet_max-z_zmet_min))*z_nbin_zmet
...
c            if (z_lgamma(i_sfh).lt.z_lgamma_min) then
c               z_lgamma(i_sfh)=z_lgamma_min
c            endif
            aux=((z_lgamma(i_sfh)-z_lgamma_min)/(z_lgamma_max-z_lgamma_min))*z_nbin_lgamma
            z_i_lgamma(i_sfh)=1+dint(aux)

            if (z_ltlastb(i_sfh).lt.z_ltlastb_min) then
               z_ltlastb(i_sfh)=z_ltlastb_min
            endif
            aux=((z_ltlastb(i_sfh)-z_ltlastb_min)/(z_ltlastb_max-z_ltlastb_min))*z_nbin_ltlastb
            z_i_ltlastb(i_sfh)=1+dint(aux)

            if (z_lagem(i_sfh).lt.z_lagem_min) then
               z_lagem(i_sfh)=z_lagem_min
            endif
            aux=((z_lagem(i_sfh)-z_lagem_min)/(z_lagem_max-z_lagem_min))*z_nbin_lagem
            z_i_lagem(i_sfh)=1+dint(aux)

            if (z_lager(i_sfh).lt.z_lager_min) then
               z_lager(i_sfh)=z_lager_min
            endif
            aux=((z_lager(i_sfh)-z_lager_min)/(z_lager_max-z_lager_min))*z_nbin_lager
            z_i_lager(i_sfh)=1+dint(aux)

            if (z_lsfr16(i_sfh).lt.z_lsfr16_min) then
               z_lsfr16(i_sfh)=z_lsfr16_min
            endif
            aux=((z_lsfr16(i_sfh)-z_lsfr16_min)/(z_lsfr16_max-z_lsfr16_min))*z_nbin_lsfr16
            z_i_lsfr16(i_sfh)=1+dint(aux)

            if (z_lsfr17(i_sfh).lt.z_lsfr17_min) then
               z_lsfr17(i_sfh)=z_lsfr17_min
            endif
            aux=((z_lsfr17(i_sfh)-z_lsfr17_min)/(z_lsfr17_max-z_lsfr17_min))*z_nbin_lsfr17
            z_i_lsfr17(i_sfh)=1+dint(aux)

            if (z_lsfr18(i_sfh).lt.z_lsfr18_min) then
               z_lsfr18(i_sfh)=z_lsfr18_min
            endif
            aux=((z_lsfr18(i_sfh)-z_lsfr18_min)/(z_lsfr18_max-z_lsfr18_min))*z_nbin_lsfr18
            z_i_lsfr18(i_sfh)=1+dint(aux)

            if (z_lsfr19(i_sfh).lt.z_lsfr19_min) then
               z_lsfr19(i_sfh)=z_lsfr19_min
            endif
            aux=((z_lsfr19(i_sfh)-z_lsfr19_min)/(z_lsfr19_max-z_lsfr19_min))*z_nbin_lsfr19
            z_i_lsfr19(i_sfh)=1+dint(aux)

            if (z_lsfr29(i_sfh).lt.z_lsfr29_min) then
               z_lsfr29(i_sfh)=z_lsfr29_min
            endif
            aux=((z_lsfr29(i_sfh)-z_lsfr29_min)/(z_lsfr29_max-z_lsfr29_min))*z_nbin_lsfr29
            z_i_lsfr29(i_sfh)=1+dint(aux)

            if (z_lfb16(i_sfh).lt.z_lfb16_min) then
               z_lfb16(i_sfh)=z_lfb16_min
            endif
            aux=((z_lfb16(i_sfh)-z_lfb16_min)/(z_lfb16_max-z_lfb16_min))*z_nbin_lfb16
            z_i_lfb16(i_sfh)=1+dint(aux)

            if (z_lfb17(i_sfh).lt.z_lfb17_min) then
               z_lfb17(i_sfh)=z_lfb17_min
            endif
            aux=((z_lfb17(i_sfh)-z_lfb17_min)/(z_lfb17_max-z_lfb17_min))*z_nbin_lfb17
            z_i_lfb17(i_sfh)=1+dint(aux)

            if (z_lfb18(i_sfh).lt.z_lfb18_min) then
               z_lfb18(i_sfh)=z_lfb18_min
            endif
            aux=((z_lfb18(i_sfh)-z_lfb18_min)/(z_lfb18_max-z_lfb18_min))*z_nbin_lfb18
            z_i_lfb18(i_sfh)=1+dint(aux)

            if (z_lfb19(i_sfh).lt.z_lfb19_min) then
               z_lfb19(i_sfh)=z_lfb19_min
            endif
            aux=((z_lfb19(i_sfh)-z_lfb19_min)/(z_lfb19_max-z_lfb19_min))*z_nbin_lfb19
            z_i_lfb19(i_sfh)=1+dint(aux)


            if (z_lfb29(i_sfh).lt.z_lfb29_min) then
               z_lfb29(i_sfh)=z_lfb29_min
            endif
...
c     sSFR_0.1Gyr
                  ibin= i_lssfr(i_sfh)
CZZ typo? use next line                 ibin = max(1,min(ibin,nbin_sfr))
                  ibin = max(1,min(ibin,nbin_ssfr))
                  pssfr(ibin)=pssfr(ibin)+prob

czz added parameters
c     metalicity
                  ibin = z_i_zmet(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_zmet))
                  z_pzmet(ibin)=z_pzmet(ibin)+prob
c tform
                  ibin = z_i_ltform(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_ltform))
                  z_pltform(ibin)=z_pltform(ibin)+prob

                  ibin = z_i_lgamma(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lgamma))
                  z_plgamma(ibin)=z_plgamma(ibin)+prob

                  ibin = z_i_ltlastb(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_ltlastb))
                  z_pltlastb(ibin)=z_pltlastb(ibin)+prob

                  ibin = z_i_lagem(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lagem))
                  z_plagem(ibin)=z_plagem(ibin)+prob

                  ibin = z_i_lager(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lager))
                  z_plager(ibin)=z_plager(ibin)+prob

                  ibin = z_i_lsfr16(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lsfr16))
                  z_plsfr16(ibin)=z_plsfr16(ibin)+prob

                  ibin = z_i_lsfr17(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lsfr17))
                  z_plsfr17(ibin)=z_plsfr17(ibin)+prob


                  ibin = z_i_lsfr18(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lsfr18))
                  z_plsfr18(ibin)=z_plsfr18(ibin)+prob

                  ibin = z_i_lsfr19(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lsfr19))
                  z_plsfr19(ibin)=z_plsfr19(ibin)+prob


                  ibin = z_i_lsfr29(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lsfr29))
                  z_plsfr29(ibin)=z_plsfr29(ibin)+prob

                  ibin = max(1,min(ibin,z_nbin_lfb16))
                  z_plfb16(ibin)=z_plfb16(ibin)+prob

                  ibin = z_i_lfb17(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lfb17))
                  z_plfb17(ibin)=z_plfb17(ibin)+prob


                  ibin = z_i_lfb18(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lfb18))
                  z_plfb18(ibin)=z_plfb18(ibin)+prob

                  ibin = z_i_lfb19(i_sfh)
                  ibin = max(1,min(ibin,z_nbin_lfb19))
                  z_plfb19(ibin)=z_plfb19(ibin)+prob


                  ibin = z_i_lfb29(i_sfh)
...
czz added parameters
            z_pzmet(i)=z_pzmet(i)/ptot
            z_pltform(i)=z_pltform(i)/ptot
            z_plgamma(i)=z_plgamma(i)/ptot
            z_pltlastb(i)=z_pltlastb(i)/ptot
            z_plagem(i)=z_plagem(i)/ptot
            z_plager(i)=z_plager(i)/ptot
            z_plsfr16(i)=z_plsfr16(i)/ptot
            z_plsfr17(i)=z_plsfr17(i)/ptot
            z_plsfr18(i)=z_plsfr18(i)/ptot
            z_plsfr19(i)=z_plsfr19(i)/ptot
            z_plsfr29(i)=z_plsfr29(i)/ptot
            z_plfb16(i)=z_plfb16(i)/ptot
            z_plfb17(i)=z_plfb17(i)/ptot
...
czz added parameters
         call get_percentiles(z_nbin_zmet,z_zmet_hist,z_pzmet,z_pct_zmet)
         call get_percentiles(z_nbin_ltform,z_ltform_hist,z_pltform,z_pct_ltform)
         call get_percentiles(z_nbin_lgamma,z_lgamma_hist,z_plgamma,z_pct_lgamma)
         call get_percentiles(z_nbin_ltlastb,z_ltlastb_hist,z_pltlastb,z_pct_ltlastb)
         call get_percentiles(z_nbin_lagem,z_lagem_hist,z_plagem,z_pct_lagem)
         call get_percentiles(z_nbin_lager,z_lager_hist,z_plager,z_pct_lager)
         call get_percentiles(z_nbin_lsfr16,z_lsfr16_hist,z_plsfr16,z_pct_lsfr16)
         call get_percentiles(z_nbin_lsfr17,z_lsfr17_hist,z_plsfr17,z_pct_lsfr17)
         call get_percentiles(z_nbin_lsfr18,z_lsfr18_hist,z_plsfr18,z_pct_lsfr18)
         call get_percentiles(z_nbin_lsfr19,z_lsfr19_hist,z_plsfr19,z_pct_lsfr19)
         call get_percentiles(z_nbin_lsfr29,z_lsfr29_hist,z_plsfr29,z_pct_lsfr29)
         call get_percentiles(z_nbin_lfb16,z_lfb16_hist,z_plfb16,z_pct_lfb16)
         call get_percentiles(z_nbin_lfb17,z_lfb17_hist,z_plfb17,z_pct_lfb17)
...
c     from 3000 max bins to 300 max bins for storing in output file + plotting
c     ---------------------------------------------------------------------------
         do i=1,300
            psfh2(i)=0.
            pir2(i)=0.
...
c     New histogram parameters
         ...
         ssfr_max=-6.0
czz added parameters
         z_dzmet=0.05         ! CZZ CHECK THESE VALUES
         z_zmet_min=0.
         z_zmet_max=2.
         z_dltform=0.1
         z_dlgamma=0.1
...
czz added parameters
         call degrade_hist(z_dzmet,z_zmet_min,z_zmet_max,z_nbin_zmet,z_nbin2_zmet,
     +        z_zmet_hist,z_zmet2_hist,z_pzmet,z_pzmet2)
         call degrade_hist(z_dltform,z_ltform_min,z_ltform_max,z_nbin_ltform,z_nbin2_ltform,
     +        z_ltform_hist,z_ltform2_hist,z_pltform,z_pltform2)
         call degrade_hist(z_dlgamma,z_lgamma_min,z_lgamma_max,z_nbin_lgamma,z_nbin2_lgamma,
     +        z_lgamma_hist,z_lgamma2_hist,z_plgamma,z_plgamma2)
         call degrade_hist(z_dltlastb,z_ltlastb_min,z_ltlastb_max,z_nbin_ltlastb,z_nbin2_ltlastb,
     +        z_ltlastb_hist,z_ltlastb2_hist,z_pltlastb,z_pltlastb2)
         call degrade_hist(z_dlagem,z_lagem_min,z_lagem_max,z_nbin_lagem,z_nbin2_lagem,
     +        z_lagem_hist,z_lagem2_hist,z_plagem,z_plagem2)
         call degrade_hist(z_dlager,z_lager_min,z_lager_max,z_nbin_lager,z_nbin2_lager,
     +        z_lager_hist,z_lager2_hist,z_plager,z_plager2)
         call degrade_hist(z_dlsfr16,z_lsfr16_min,z_lsfr16_max,z_nbin_lsfr16,z_nbin2_lsfr16,
     +        z_lsfr16_hist,z_lsfr162_hist,z_plsfr16,z_plsfr162)
         call degrade_hist(z_dlsfr17,z_lsfr17_min,z_lsfr17_max,z_nbin_lsfr17,z_nbin2_lsfr17,
     +        z_lsfr17_hist,z_lsfr172_hist,z_plsfr17,z_plsfr172)
         call degrade_hist(z_dlsfr18,z_lsfr18_min,z_lsfr18_max,z_nbin_lsfr18,z_nbin2_lsfr18,
     +        z_lsfr18_hist,z_lsfr182_hist,z_plsfr18,z_plsfr182)
         call degrade_hist(z_dlsfr19,z_lsfr19_min,z_lsfr19_max,z_nbin_lsfr19,z_nbin2_lsfr19,
     +        z_lsfr19_hist,z_lsfr192_hist,z_plsfr19,z_plsfr192)
         call degrade_hist(z_dlsfr29,z_lsfr29_min,z_lsfr29_max,z_nbin_lsfr29,z_nbin2_lsfr29,
     +        z_lsfr29_hist,z_lsfr292_hist,z_plsfr29,z_plsfr292)
         call degrade_hist(z_dlfb16,z_lfb16_min,z_lfb16_max,z_nbin_lfb16,z_nbin2_lfb16,
     +        z_lfb16_hist,z_lfb162_hist,z_plfb16,z_plfb162)
         call degrade_hist(z_dlfb17,z_lfb17_min,z_lfb17_max,z_nbin_lfb17,z_nbin2_lfb17,
     +        z_lfb17_hist,z_lfb172_hist,z_plfb17,z_plfb172)
         call degrade_hist(z_dlfb18,z_lfb18_min,z_lfb18_max,z_nbin_lfb18,z_nbin2_lfb18,
     +        z_lfb18_hist,z_lfb182_hist,z_plfb18,z_plfb182)
         call degrade_hist(z_dlfb19,z_lfb19_min,z_lfb19_max,z_nbin_lfb19,z_nbin2_lfb19,
...
czz added parameters
         write(31,9811)
 9811     format('# ... metalicity Z/Zo ...')
         do ibin=1,z_nbin2_zmet
            write(31,9812) z_zmet2_hist(ibin),z_pzmet2(ibin)
         enddo
 9812     format(1p2e12.3e3)
         write(31,60)
         write(31,62) (z_pct_zmet(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_pzmet2, zmet2_hist, z_nbin2_zmet)
         write(31, 900)
         write(31, 901) hpbv, zmet2_hist(1), zmet2_hist(z_nbin2_zmet), zmet2_hist(2) - zmet2_hist(1)
c theSkyNet

         write(31,9813)
 9813     format('# ... tform ...')
         do ibin=1,z_nbin2_ltform
            write(31,9812) z_ltform2_hist(ibin),z_pltform2(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_ltform(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_pltform2, z_ltform2_hist, z_nbin2_ltform)
         write(31, 900)
         write(31, 901) hpbv, z_ltform2_hist(1), z_ltform2_hist(z_nbin2_ltform), z_ltform2_hist(2) - z_ltform2_hist(1)
c theSkyNet

         write(31,9814)
 9814     format('# ... gamma ...')
         do ibin=1,z_nbin2_lgamma
            write(31,9812) z_lgamma2_hist(ibin),z_plgamma2(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lgamma(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plgamma2, z_lgamma2_hist, z_nbin2_lgamma)
         write(31, 900)
         write(31, 901) hpbv, z_lgamma2_hist(1), z_lgamma2_hist(z_nbin2_lgamma), z_lgamma2_hist(2) - z_lgamma2_hist(1)
c theSkyNet

         write(31,9815)
 9815     format('# ... tlastb ...')
         do ibin=1,z_nbin2_ltlastb
            write(31,9812) z_ltlastb2_hist(ibin),z_pltlastb2(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_ltlastb(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_pltlastb2, z_ltlastb2_hist, z_nbin2_ltlastb)
         write(31, 900)
         write(31, 901) hpbv, z_ltlastb2_hist(1), z_ltlastb2_hist(z_nbin2_ltlastb), z_ltlastb2_hist(2) - z_ltlastb2_hist(1)
c theSkyNet

         write(31,9816)
 9816     format('# ... agem ...')
         do ibin=1,z_nbin2_lagem
            write(31,9812) z_lagem2_hist(ibin),z_plagem2(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lagem(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plagem2, z_lagem2_hist, z_nbin2_lagem)
         write(31, 900)
         write(31, 901) hpbv, z_lagem2_hist(1), z_lagem2_hist(z_nbin2_lagem), z_lagem2_hist(2) - z_lagem2_hist(1)
c theSkyNet

         write(31,9817)
 9817     format('# ... ager ...')
         do ibin=1,z_nbin2_lager
            write(31,9812) z_lager2_hist(ibin),z_plager2(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lager(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plager2, z_lager2_hist, z_nbin2_lager)
         write(31, 900)
         write(31, 901) hpbv, z_lager2_hist(1), z_lager2_hist(z_nbin2_lager), z_lager2_hist(2) - z_lager2_hist(1)
c theSkyNet

         write(31,9818)
 9818     format('# ... sfr16 ...')
         do ibin=1,z_nbin2_lsfr16
            write(31,9812) z_lsfr162_hist(ibin),z_plsfr162(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lsfr16(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plsfr162, z_lsfr162_hist, z_nbin2_lsfr16)
         write(31, 900)
         write(31, 901) hpbv, z_lsfr162_hist(1), z_lsfr162_hist(z_nbin2_lsfr16), z_lsfr162_hist(2) - z_lsfr162_hist(1)
c theSkyNet

         write(31,9819)
 9819     format('# ... sfr17 ...')
         do ibin=1,z_nbin2_lsfr17
            write(31,9812) z_lsfr172_hist(ibin),z_plsfr172(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lsfr17(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plsfr172, z_lsfr172_hist, z_nbin2_lsfr17)
         write(31, 900)
         write(31, 901) hpbv, z_lsfr172_hist(1), z_lsfr172_hist(z_nbin2_lsfr17), z_lsfr172_hist(2) - z_lsfr172_hist(1)
c theSkyNet

         write(31,9820)
 9820     format('# ... sfr18 ...')
         do ibin=1,z_nbin2_lsfr18
            write(31,9812) z_lsfr182_hist(ibin),z_plsfr182(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lsfr18(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plsfr182, z_lsfr182_hist, z_nbin2_lsfr18)
         write(31, 900)
         write(31, 901) hpbv, z_lsfr182_hist(1), z_lsfr182_hist(z_nbin2_lsfr18), z_lsfr182_hist(2) - z_lsfr182_hist(1)
c theSkyNet

         write(31,9821)
 9821     format('# ... sfr19 ...')
         do ibin=1,z_nbin2_lsfr19
            write(31,9812) z_lsfr192_hist(ibin),z_plsfr192(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lsfr19(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plsfr192, z_lsfr192_hist, z_nbin2_lsfr19)
         write(31, 900)
         write(31, 901) hpbv, z_lsfr192_hist(1), z_lsfr192_hist(z_nbin2_lsfr19), z_lsfr192_hist(2) - z_lsfr192_hist(1)
c theSkyNet

         write(31,9822)
 9822     format('# ... sfr29 ...')
         do ibin=1,z_nbin2_lsfr29
            write(31,9812) z_lsfr292_hist(ibin),z_plsfr292(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lsfr29(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plsfr292, z_lsfr292_hist, z_nbin2_lsfr29)
         write(31, 900)
         write(31, 901) hpbv, z_lsfr292_hist(1), z_lsfr292_hist(z_nbin2_lsfr29), z_lsfr292_hist(2) - z_lsfr292_hist(1)
c theSkyNet

         write(31,9823)
 9823     format('# ... fb16 ...')
         do ibin=1,z_nbin2_lfb16
            write(31,9812) z_lfb162_hist(ibin),z_plfb162(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lfb16(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plfb162, z_lfb162_hist, z_nbin2_lfb16)
         write(31, 900)
         write(31, 901) hpbv, z_lfb162_hist(1), z_lfb162_hist(z_nbin2_lfb16), z_lfb162_hist(2) - z_lfb162_hist(1)
c theSkyNet

         write(31,9824)
 9824     format('# ... fb17 ...')
         do ibin=1,z_nbin2_lfb17
            write(31,9812) z_lfb172_hist(ibin),z_plfb172(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lfb17(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plfb172, z_lfb172_hist, z_nbin2_lfb17)
         write(31, 900)
         write(31, 901) hpbv, z_lfb172_hist(1), z_lfb172_hist(z_nbin2_lfb17), z_lfb172_hist(2) - z_lfb172_hist(1)
c theSkyNet

         write(31,9825)
 9825     format('# ... fb18 ...')
         do ibin=1,z_nbin2_lfb18
            write(31,9812) z_lfb182_hist(ibin),z_plfb182(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lfb18(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plfb182, z_lfb182_hist, z_nbin2_lfb18)
         write(31, 900)
         write(31, 901) hpbv, z_lfb182_hist(1), z_lfb182_hist(z_nbin2_lfb18), z_lfb182_hist(2) - z_lfb182_hist(1)
c theSkyNet

         write(31,9826)
 9826     format('# ... fb19 ...')
         do ibin=1,z_nbin2_lfb19
            write(31,9812) z_lfb192_hist(ibin),z_plfb192(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lfb19(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plfb192, z_lfb192_hist, z_nbin2_lfb19)
         write(31, 900)
         write(31, 901) hpbv, z_lfb192_hist(1), z_lfb192_hist(z_nbin2_lfb19), z_lfb192_hist(2) - z_lfb192_hist(1)
c theSkyNet

         write(31,9827)
 9827     format('# ... fb29 ...')
         do ibin=1,z_nbin2_lfb29
            write(31,9812) z_lfb292_hist(ibin),z_plfb292(ibin)
         enddo
         write(31,60)
         write(31,62) (z_pct_lfb29(k),k=1,5)
c theSkyNet
         hpbv = get_hpbv(z_plfb292, z_lfb292_hist, z_nbin2_lfb29)
         write(31, 900)
         write(31, 901) hpbv, z_lfb292_hist(1), z_lfb292_hist(nbin2_sfr), z_lfb292_hist(2) - z_lfb292_hist(1)
c theSkyNet
