...
def main(argv):
    ...
    while 1:
        try:
            ...
            Thread(target=handle_client, args=(log_directory, client_socket, logger_number)).start()

            # Next client must use a different local logger. Add '1' to the name of the previous local logger
            logger_number += 1
