...
CREATE TABLE run_filter (
  run_filter_id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE register (
  register_id    INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE galaxy (
  galaxy_id              INTEGER UNSIGNED NOT NULL PRIMARY KEY,
  run_id                 BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE fits_header (
  fitsheader_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE area (
  area_id      BIGINT UNSIGNED NOT NULL PRIMARY KEY,
  galaxy_id    BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE area_user (
  areauser_id  INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE pixel_result (
  pxresult_id INTEGER UNSIGNED NOT NULL PRIMARY KEY,
  area_id     BIGINT UNSIGNED NOT NULL,
  galaxy_id   BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE image_filters_used (
  image_filters_used_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE hdf5_request (
  hdf5_request_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE hdf5_feature (
  hdf5_feature_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE hdf5_layer (
  hdf5_layer_id   INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE hdf5_request_galaxy (
  hdf5_request_galaxy_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE hdf5_request_feature (
  hdf5_request_feature_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  hdf5_request_id         BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE hdf5_request_layer (
  hdf5_request_layer_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  hdf5_request_id       BIGINT UNSIGNED NOT NULL,
...
CREATE TABLE tag_register (
  tag_register_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE tag_galaxy (
  tag_galaxy_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  tag_id        BIGINT UNSIGNED NOT NULL,
  galaxy_id     BIGINT UNSIGNED NOT NULL,
  created_at    TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE galaxy_user (
  galaxy_user_id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  galaxy_id      BIGINT UNSIGNED NOT NULL,
  userid         INTEGER NOT NULL,
